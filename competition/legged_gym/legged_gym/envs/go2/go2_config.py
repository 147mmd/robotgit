...
class Go2RoughCfg( LeggedRobotCfg ):
    ...
    class terrain( LeggedRobotCfg.env ): #储存地面信息
        mesh_type = 'competition' # "heightfield" # none, plane, heightfield or trimesh
        horizontal_scale = 0.25 # [m] #horizontal_scale 也是一个类属性，表示地形的水平缩放比例。0.25 是缩放值，单位是米。#
        #这个值可能控制在仿真中地形网格的分辨率或尺寸。
        #假如地面12*108，地面的宽为12m，换成所用维度为12/0.25=48维
